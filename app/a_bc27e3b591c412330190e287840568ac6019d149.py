...
def generate_json_html_report(json_data, json_file_path):
    ...
    <head>
        ...
        <style>
            ...
            pre {{ white-space: pre-wrap; margin: 0; color: #2c3e50; font-size: 16px; }} 
            /*pre {{ white-space: pre-wrap; margin: 0; color: #2c3e50; font-size: 16px; text-indent: -2em; padding-left: 2em; }} */
